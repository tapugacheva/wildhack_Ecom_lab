...
products_seller = ['7D9A98C6E8BF033613B74252D9D24B33',
...
reco_act = 'Рекомендуем поучаствовать в промоакции (ссылка на участие в промоакции)'
text_conv_cart = 'Конверсия из просмотров в добавление в корзину - у Вашего товара'
text_conv_purch = 'Конверсия из добавления в корзину в покупку - у Вашего товара-'